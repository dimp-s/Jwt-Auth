    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 8, "Beginner friendly course to learn JAVA programming. Get Started now with improved lessons.", "Intro to Java" },
                    { 2, 4, "Beginner friendly course to learn c# programming. Get Started now with improved lessons.", "Intro to C#" },
                    { 3, 12, "Beginner friendly course to start with AWS. Get Started now with improved lessons.", "AWS Beginner Pack" }
                });
